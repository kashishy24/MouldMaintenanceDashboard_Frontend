...
const tableDummyData = [
  {
    ...
    PMWarning: 10000,
    NextPMDueDate: "2025-11-20",
    NextPMWarningDate: "2025-11-15",
    MouldLifeStatus: "Good",
    MouldPMStatus: "On Time",
    MouldStatus: "Running",
  },
  {
    UID: "PM0002",
    ...
    PMWarning: 14000,
    NextPMDueDate: "2025-11-22",
    NextPMWarningDate: "2025-11-19",
    MouldLifeStatus: "Critical",
    MouldPMStatus: "Delayed",
    MouldStatus: "Running",
  },
  {
    UID: "PM0003",
    ...
    PMWarning: 14000,
    NextPMDueDate: "2025-11-25",
    NextPMWarningDate: "2025-11-20",
  ...
  },
  {
    ...
    PMWarning: 9000,
    NextPMDueDate: "2025-11-30",
    NextPMWarningDate: "2025-11-28",
    MouldLifeStatus: "Critical",
    MouldPMStatus: "On Time",
    MouldStatus: "Running",
  },
  {
    ...
    PMWarning: 16000,
    NextPMDueDate: "2025-12-05",
    NextPMWarningDate: "2025-12-01",
    MouldLifeStatus: "Warning",
    MouldPMStatus: "Delayed",
    MouldStatus: "Running",
  },
            ...
            <table className="w-full border-collapse">
              <thead className="bg-gray-900 text-white">
                <tr>
                  ...
                  <th className="p-3 border">PM Warning</th>
                  <th className="p-3 border">Next PM Due</th>
                  <th className="p-3 border">Next PM Warning</th>
                  <th className="p-3 border">Life Status</th>
                  <th className="p-3 border">PM Status</th>
              ...
              <tbody>
                {tableDummyData.map((row, index) => (
                  <tr key={index} className="text-center border">
                    ...
                    <td className="p-3 border">{row.PMWarning}</td>
                    <td className="p-3 border">{row.NextPMDueDate}</td>
                    <td className="p-3 border">{row.NextPMWarningDate}</td>
                    <td className="p-3 border">{row.MouldLifeStatus}</td>
                    <td className="p-3 border">{row.MouldPMStatus}</td>
