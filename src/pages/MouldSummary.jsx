...
const MouldSummary = () => {
  ...
  const mouldList = [
    { MouldID: "M01", MouldName: "Mould 01" },
    { MouldID: "M02", MouldName: "Mould 02" },
    { MouldID: "M03", MouldName: "Mould 03" },
  ];
  ...
  <div className="grid grid-cols-3 gap-6">
    ...
    <div>
      ...
      <div className="bg-gray-100 px-4 py-3 rounded-lg shadow-sm font-semibold text-gray-800">
        190800000666  {/* replace with dynamic value */}
      </div>
    </div>
    ...
    <div>
      ...
      <div className="bg-gray-100 px-4 py-3 rounded-lg shadow-sm font-semibold text-gray-800">
        YCA HL Ext  {/* replace with dynamic value */}
      </div>
    </div>
        ...
        <BarChart data={pmDuration} margin={{ bottom: 20 }}>
          ...
          <Bar dataKey="duration" radius={[4, 4, 0, 0]}>
            {pmDuration.map((entry, index) => (
              <Cell
                key={index}
                fill={entry.status === "OnTime" ? "#16a34a" : "#dc2626"}
              />
            ))}
          </Bar>
        </BarChart>
